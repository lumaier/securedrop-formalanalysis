...
if argv[1] in ['Auto_Secrecy_Source_Message']:
  match = matchAgainstList([
    ...
    '!KU( kdf(<z, z.1, \'g\'^~me_sk, j_edh_pk,           \'g\'^kdf(<\'DH\', ~passphrase>)>))',
    '((∀ #x. (Reveal_Journalist_EDH_Key( \'g\'^~j_edh_sk ) @ #x) ⇒ ⊥)',
    '!KU( aenc(<\'cipher_s2j\',',
    '!KU( kdf(~ss) )',
    '!KU( \'g\'^(~j_edh_sk*~me_sk) )',
    '!KU( j_edh_pk^~me_sk )',
    '!KU( sign(<\'ephemeral',
    '!KU( kdf(<\'g\'^(~j_edh_sk*kdf(<\'DH\', ~passphrase>)),',
    '(∀ #x. (Reveal_Journalist_EDH_Key( \'g\'^~j_edh_sk ) @ #x) ⇒ ⊥)',
    '!KU( sign(<\'signature',
    '!KU( ~'
  ], lines)
  ...
  match = matchAgainstList([
    ...
    '!KU( ~j_sig_sk )',
    '!KU( kdf(<\'DH\', ~passphrase>) )',
    re.compile(r'!KU\( aenc\(<\'cipher_s2j\',\s*\'g\'\^\(\~j_edh_sk'),
    re.compile(r'!KU\( aenc\(<\'cipher_s2j\',\s*\'g\'\^\(\~me_sk'),
    re.compile(r'!KU\( aenc\(<\'cipher_s2j\',\s*\'g\'\^\~me_sk'),
    re.compile(r'!KU\( aenc\(<\'cipher_s2j\',\s*\'g\'\^x'),
    re.compile(r'!KU\( aenc\(<\'cipher_s2j\',\s*\'g\'\^\(x'),
    '!KU( \'g\'^(~j_edh_sk*kdf(<\'DH\', ~passphrase>)) )',
    '!KU( sign(<\'ephemeral\', \'g\'^~j_edh_sk, pk(x.1), pqpk(~j_ekem_sk)>, ',
    ...
    '!KU( senc(<\'msg_s2j\', ~msg,',
    '(#x2',
    '!KU( H(kdf(<\'g\'^(~j_edh_sk.1*kdf(<\'DH\', ~passphrase>))',
    '!KU( H(kdf(<\'g\'^(~j_edh_sk*kdf(<\'DH\', ~passphrase>)),             \'g\'^(~j_edh_sk*~x), \'g\'^~x, j_edh_pk, \'g\'^kdf(<\'DH\', ~passphrase>)           >),       \'g\'^~x, z, c_pq))',
    '!KU( kdf(<\'g\'^(~j_edh_sk*kdf(<\'DH\', ~passphrase>)),           \'g\'^(~j_edh_sk*~x), \'g\'^~x, j_edh_pk, \'g\'^kdf(<\'DH\', ~passphrase>)         >))',
    '!KU( ~msg )',
    '!KU( kdf(<\'g\'^(~j_edh_sk*kdf(<\'DH\', ~passphrase>)),',
    '!KU( kdf(<\'g\'^(~j_edh_sk.1*kdf(<\'DH\', ~passphrase>)),',
    'splitEqs(3)',
    '!KU( aenc',
    '!KU( \'g\'^~x'
  ], lines)
  ...
  match = matchAgainstList([
    ...
    re.compile(r'!KU\( aenc\(<\'cipher_j2s\',\s*\'g\'\^\(\~j_edh_sk'),
  ...
  match = matchAgainstList([
    ...
    '!KU( ~j_dh_sk',
    '!KU( kdf(<\'DH\', ~passphrase>) )',
    '!KU( \'g\'^(~j_edh_sk*kdf(<\'DH\', ~passphrase>)) ) @ #vk.41',
    '!KU( \'g\'^(~j_edh_sk*kdf(<\'DH\', ~passphrase>)) ) @ #vk.38',
    '!KU( \'g\'^(~j_dh_sk*kdf(<\'DH\', ~passphrase>))',
    ...
    '!KU( H(kdf(<\'g\'^(~j_edh_sk*kdf(<\'DH\', ~passphrase>)),',
